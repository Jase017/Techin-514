...
const char* password = "6D)>3)F;Pt"; // Replace with your network password
#define DATABASE_URL "https://esp32-firebase-demo1-5467c-default-rtdb.firebaseio.com/" // Replace with your database URL
#define API_KEY "AIzaSyB9Jq_7HhBsf-6h0TlCLNKxmJYhXveGKzM" // Replace with your API key
...
#define SLEEP_DURATION 40000 // Sleep for 40 seconds in microseconds
unsigned long lastBelowThresholdTime = 0;
const float distanceThreshold = 60.0; // 60 cm threshold
